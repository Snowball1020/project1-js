...
function About () {
    ...
    return(
        <Container className="card mt-4">
            <div className="card-header bg-success text-white my-4">
            Welcome to Virtualmart App / Created by Yuki Miyazawa
            </div>

            <ul className="list-group list-group-flush">
                <li className="list-group-item bg-secondary text-white">Instructions</li>
                ...
                <li className="list-group-item bg-secondary text-white">Menu below is available only for a logged in user</li>
